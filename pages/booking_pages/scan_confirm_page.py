...
class ScanConfirmPage(BasePage):
    ...
    def __init__(self, page: Page, path: str = PATH):
        ...
        self.begin_medical_questionnaire_button = "button:has-text('Begin Medical Questionnaire')"
        self.back_to_dashboard_button_selector = "a:has(div:has-text('Go to Dashboard'))"
