...
class BaseComponent:
    ...
    def fill(self, selector: str, value: str) -> None:
        self.logger.info(f"Filling element {selector} with: {value}")
        self.root.locator(selector).fill(value)

    def select_option(self, selector: str, value: str) -> None:
        self.logger.info(f"Selecting option '{value}' in: {selector}")
        self.root.locator(selector).select_option(value)
    ...
    def verify_text(self, selector: str, expected_text: str, timeout: int = 5000) -> None:
        self.logger.info(f"Verifying element {selector} has text: {expected_text}")
    ...
    def verify_has_class(self, selector: str, expected_class: str, strict: bool = True, timeout: int = 5000) -> None:
        self.logger.info(f"Verifying element {selector} has class: {expected_class}")
    ...
    def verify_elem_visible(self, selector: str, timeout: int = 5000) -> None:
        self.logger.info(f"Verifying element is visible: {selector}")
    ...
    def verify_elem_hidden(self, selector: str, timeout: int = 5000) -> None:
        self.logger.info(f"Verifying element is hidden: {selector}")
